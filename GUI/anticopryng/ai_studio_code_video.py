...
def procesar_variaciones_multimedia(entrada_dir, salida_dir, crf=21, preset="medium", seed=None):
    ...
    if not ffmpeg_cmd:
        ...
        return # Usamos return en lugar de sys.exit para no detener el proceso principal
    ...
    recetas_audio_mejoradas = [
        {"name": "pitch_up_ligero", "af": "asetrate=44100*1.005,aresample=44100"},
        {"name": "pitch_down_ligero", "af": "asetrate=44100*0.995,aresample=44100"},
        {"name": "tempo_rapido_ligero", "af": "atempo=1.008"},
        {"name": "tempo_lento_ligero", "af": "atempo=0.992"},
        {"name": "bass_boost_ligero", "af": "equalizer=f=60:width_type=h:width=20:g=2"},
        {"name": "treble_boost_ligero", "af": "equalizer=f=8000:width_type=h:width=2000:g=2"},
        {"name": "rapido_y_agudo_ligero", "af": "atempo=1.004,asetrate=44100*1.002,aresample=44100"},
    ]
...
if __name__ == "__main__":
    ...
    procesar_variaciones_multimedia(entrada_dir_arg, salida_dir_arg, crf=23, preset="medium")
