...
nombre_archivo = "padre_nuestro.txt"  # Cambialo por el nombre del guion que tengas
...
mensaje_ia = (
    "A partir del siguiente texto, genera exclusivamente una lista de 10 prompts detallados en español para crear imágenes que acompañen ese contenido.\n"
    "Cada prompt debe transmitir una atmósfera de tranquilidad, paz interior, espiritualidad o inspiración emocional.\n"
    "Utiliza un estilo visual similar al de Studio Ghibli o ilustraciones artísticas suaves, con luz cálida, composición armoniosa, detalles delicados y colores vibrantes.\n"
    "Evita incoherencias como combinaciones ilógicas (por ejemplo, 'dos padres' en lugar de una familia con padre, madre e hijo/a) y prefiere escenas naturales, significativas y emocionalmente claras.\n"
    "Inspírate en la belleza de la naturaleza, momentos de ternura humana, esperanza, inocencia, y escenas cotidianas que evoquen profundidad emocional o espiritual.\n"
